...
public class TelaAtendimento extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Diagnóstico", "Temperatura", "PA Alta", "PA Baixa", "Médico"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.Object.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class
            };
        ...
        dtAtendimento.setEditable(false);
...
private void pegaId(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pegaId
  try {
        pegarId();
    } catch (SQLException ex) {
        Logger.getLogger(TelaAtendimento.class.getName()).log(Level.SEVERE, null, ex);
    }
}//GEN-LAST:event_pegaId

private void navegarEntreTabela(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_navegarEntreTabela
  try {
        pegarId();
    } catch (SQLException ex) {
        Logger.getLogger(TelaAtendimento.class.getName()).log(Level.SEVERE, null, ex);
    }
}//GEN-LAST:event_navegarEntreTabela
    ...
    private void salvar() {
        ...
        try {
            if (this.isInserir()) {
                ...
                atendimento.setNomeMedico(this.nomeMedico);
